...
class NeuralNetwork:
    ...
    # Calculates FPS
    def train_model_FPS(self, num_iterations=50, model_file_path="models\\",
                    model_name="FPS.keras", target_name="FPSTarget.keras", render=False,
                    log_file_path="training_logs\\FPS.txt", explore_frames=100):
    ...
    # Trains Model
    def train_model(self, num_iterations, load=False, model_file_path="models\\",
